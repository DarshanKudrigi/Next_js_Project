  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-md animate-fadeUp">
        ...
        <button
          type="button"
          className="w-full bg-white border border-[#E8E4DF] text-[#374151] font-medium text-sm py-3.5 rounded-xl flex items-center justify-center gap-3 hover:border-[#D0CBC4] hover:bg-[#FAFAF8] transition-all duration-200"
        >
