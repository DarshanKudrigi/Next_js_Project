...
export default function LoadingAnimation() {
  const [isVisible, setIsVisible] = useState(typeof window !== 'undefined' && !sessionStorage.getItem('hasLoadedBefore'));
    ...
    <div className="loading-screen">
      ...
      <div className="loading-container">
        <div className="logo-wrapper">
          <h1 className="logo-text">TicketPoint</h1>
        </div>

        <p className="tagline">Choose smart. Book fast.</p>
